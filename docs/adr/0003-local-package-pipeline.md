...
- Usar `PackageManager` para metadatos Android y `apksig-android` para validar los esquemas de firma. Todos los APK deben compartir package, versión y firmante; una actualización debe continuar el historial de firma instalado.
